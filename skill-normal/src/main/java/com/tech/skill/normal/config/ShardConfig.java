...
import com.tech.skill.normal.config.sharding.MyHintTableShardingAlgorithm;
import com.tech.skill.normal.config.sharding.MyPreciseTableShardingAlgorithm;
...
@Configuration
@MapperScan(basePackages = "com.tech.skill.normal.mapper", sqlSessionFactoryRef = "forgeShardingSqlSessionFactory")
public class ShardConfig {
    ...
    public SqlSessionFactory shardingSqlSessionFactory(@Qualifier("forgeDataSource") DataSource dataSource) throws Exception {
        ...
        factoryBean.setTypeAliasesPackage("com.tech.skill.normal.entity");
        //自带完善的拦截器
